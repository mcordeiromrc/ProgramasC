...
int main(){
    ...
    do{ // deseja jogar novamente?
        ...
        do{ // repete até alguém ganhar ou atingir 9 jogadas
            ...
            do{
                printf("\nJOGADOR 1 = 0\nJOGADOR 2 = X\n");
                printf("\nJOGADOR %d:\n", jogador);// irá iniciar exibindo Jogador 1
                printf("Digite a linha que deseja jogar: ");
                scanf("%d", &linha);//irá pedir a linha e irá atribuir para a variável linha
                printf("Digite a coluna que deseja jogar: ");
                scanf("%d", &coluna);//irá pedir a coluna e irá atribuir para a variável coluna
            }while(linha < 0 || linha > 2 || coluna < 0 || coluna > 2 || jogo[linha][coluna] != ' ');//irá delimitar o que o usuário digitar entre 0 e 2
